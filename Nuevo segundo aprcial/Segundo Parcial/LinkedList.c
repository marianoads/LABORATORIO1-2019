...
LinkedList* ll_filter(LinkedList* this, int (*funcionProblema)(void* element))
{
    Vuelo* pVuelo;
    ...
    if(this != NULL && nuevaLista != NULL)
    {
        ...
        {
            pVuelo=ll_get(this,i);
            if(funcionProblema(pVuelo))
            {
                ll_add(nuevaLista,pVuelo);
...
int ll_count(LinkedList* this,int (*fn)(void* element))
{
    ...
    if(this != NULL && fn != NULL)
    {
        ...
        {
            pVuelo = ll_get(this,i);
            cantElement=cantElement+fn(pVuelo);
        }
    }
